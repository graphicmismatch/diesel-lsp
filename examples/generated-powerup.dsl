...
patch {
    version = 6;
    origin = { category = "Powerup", seed = "7" };
    ...
    Constant constant1 {
        x = 40; y = 160;
        state = { value = "0.045891084" };
    }
    Constant constant2 {
        x = 40; y = 250;
        state = { value = "0.12081772" };
    }
    Constant constant3 {
        x = 40; y = 340;
        state = { value = "0.17038296" };
    }
    Constant constant4 {
        x = 40; y = 430;
        state = { value = "0.23622082" };
    }
    Constant constant5 {
        x = 40; y = 540;
        state = { value = "592.27966" };
    }
    Constant constant6 {
        x = 40; y = 630;
        state = { value = "1820.4238" };
    }
    Constant constant7 {
        x = 40; y = 720;
        state = { value = "0.23707743" };
    }
    Constant constant8 {
        x = 40; y = 830;
        state = { value = "12799.305" };
    }
    Envelope envelope1 {
        x = 280; y = 120;
    }
