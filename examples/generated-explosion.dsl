...
patch {
    version = 6;
    origin = { category = "Explosion", seed = "7" };
    ...
    Constant constant1 {
        x = 40; y = 160;
        state = { value = "0.008972771" };
    }
    Constant constant2 {
        x = 40; y = 250;
        state = { value = "0.15622658" };
    }
    Constant constant3 {
        x = 40; y = 340;
        state = { value = "0.5407659" };
    }
    Constant constant4 {
        x = 40; y = 430;
        state = { value = "0.36036804" };
    }
    Constant constant5 {
        x = 40; y = 540;
        state = { value = "319.20972" };
    }
    Constant constant6 {
        x = 40; y = 630;
        state = { value = "215.33403" };
    }
    Constant constant7 {
        x = 40; y = 720;
        state = { value = "0.30449292" };
    }
    Constant constant8 {
        x = 40; y = 830;
        state = { value = "2624.7827" };
    }
    Envelope envelope1 {
        x = 280; y = 120;
    }
    ...
    Oscillator oscillator1 {
        x = 700; y = 560;
        oscillator = { kind = "factory", name = "White Noise" };
    }
